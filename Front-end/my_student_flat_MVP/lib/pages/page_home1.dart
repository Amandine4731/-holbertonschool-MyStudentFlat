...
import 'package:my_student_flat_MVP/pages/page_home2.dart';
...
class PageHome1 extends StatefulWidget {
  const PageHome1({Key? key}) : super(key: key);

  @override
  _PageHome1State createState() => _PageHome1State();
}

class _PageHome1State extends State<PageHome1> {
  List<int> ids = [];
