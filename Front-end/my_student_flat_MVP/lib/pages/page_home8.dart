...
import 'package:my_student_flat_MVP/pages/page_home7.dart';
import 'package:my_student_flat_MVP/pages/page_home9.dart';
...
class PageHome8 extends StatefulWidget {
  const PageHome8({Key? key}) : super(key: key);

  @override
  _PageHome8State createState() => _PageHome8State();
}

class _PageHome8State extends State<PageHome8> {
  List<int> ids = [];
