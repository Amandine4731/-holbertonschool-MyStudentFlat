...
class PageHome10 extends StatefulWidget {
  const PageHome10({Key? key}) : super(key: key);

  @override
  _PageHome10State createState() => _PageHome10State();
}

class _PageHome10State extends State<PageHome10> {
  List<int> ids = [];
  ...
  Future<void> fetchIds() async {
    try {
      for (int id = 141; urlStatusCode == 200; id++) {
