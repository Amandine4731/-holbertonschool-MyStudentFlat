...
import 'package:my_student_flat_MVP/pages/page_home5.dart';
...
class PageHome6 extends StatefulWidget {
  const PageHome6({Key? key}) : super(key: key);

  @override
  _PageHome6State createState() => _PageHome6State();
}

class _PageHome6State extends State<PageHome6> {
  List<int> ids = [];
