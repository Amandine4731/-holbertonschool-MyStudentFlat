...
import 'package:my_student_flat_MVP/pages/page_home8.dart';
import 'package:my_student_flat_MVP/pages/page_home10.dart';
...
class PageHome9 extends StatefulWidget {
  const PageHome9({Key? key}) : super(key: key);

  @override
  _PageHome9State createState() => _PageHome9State();
}

class _PageHome9State extends State<PageHome9> {
  List<int> ids = [];
