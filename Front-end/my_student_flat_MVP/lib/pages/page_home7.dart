...
class PageHome7 extends StatefulWidget {
  const PageHome7({Key? key}) : super(key: key);

  @override
  _PageHome7State createState() => _PageHome7State();
}

class _PageHome7State extends State<PageHome7> {
  List<int> ids = [];
